...
from cifar_utils import kNN, CIFAR10Instance, AverageMeter, py_softmax
...
trainset = CIFAR10Instance(root=args.datadir, train=True, download=False,
                               transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=8)


testset = CIFAR10Instance(root=args.datadir, train=False, download=False,
